...
const Testimony = () : JSX.Element  => {
    return (
        <section id="testimony" className=" p-10 min-h-[70vh] text-white hover:shadow-[inset_0px_2px_20px_1px_black] section bg-[conic-gradient(at_top,_var(--tw-gradient-stops))] from-black via-gray-900 to-gray-700">
