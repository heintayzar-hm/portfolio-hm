            ...
            <div>
                <form method="post" ref={formRef}  className="flex flex-col gap-4">
                    ...
                    <label htmlFor="name" className="text-lg italic hover-class ">Name: </label>
                        <input type="text" placeholder="Name" className="h-8 italic bg-slate-400 rounded hover-input w-full focus:outline-none p-3" required />
                    </div>
                    <div className="flex gap-2">
                    <label htmlFor="Email" className="text-lg italic hover-class">Email: </label>
                    <input type="email" placeholder="Email" className="h-8 bg-slate-400 rounded italic hover-input  w-full focus:outline-none p-3" required/>
                   </div>
                    <div>
